...
CommandResult PaintingCommandExecutorGPU::push_stacking_context(float, Gfx::IntRect, CSS::ImageRendering, StackingContextTransform, Optional<StackingContextMask>)
{
    // FIXME
    return CommandResult::Continue;
}
