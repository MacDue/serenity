...
void fill_path(Painter& painter, Path const& path, ColorFunction color_function, Gfx::Painter::WindingRule winding_rule)
{
    ...
    auto origin = path.bounding_box().top_left().to_type<int>();
