...
public:
    ...
    RefPtr<Gfx::Bitmap> rasterize_glyph(u32 char_code, float width, float x_offset, float y_offset);
    Gfx::Path build_char(u32 char_code, float width, float x_offset, float y_offset);
