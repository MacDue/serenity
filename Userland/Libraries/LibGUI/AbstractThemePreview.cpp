...
void AbstractThemePreview::paint_window(StringView title, Gfx::IntRect const& rect, Gfx::WindowTheme::WindowState state, Gfx::Bitmap const& icon, int button_count)
{
    ...
    auto titlebar_text_rect = palette().window_theme().titlebar_text_rect(Gfx::WindowTheme::WindowType::Normal, Gfx::WindowTheme::WindowMode::Other, rect, m_preview_palette);
    ...
    auto frame_rect = palette().window_theme().frame_rect_for_window(Gfx::WindowTheme::WindowType::Normal, Gfx::WindowTheme::WindowMode::Other, rect, m_preview_palette, 0);
    ...
    palette().window_theme().paint_normal_frame(painter, state, Gfx::WindowTheme::WindowMode::Other, rect, title, icon, m_preview_palette, buttons.last().rect, 0, false);
...
void AbstractThemePreview::center_window_group_within(Span<Window> windows, Gfx::IntRect const& bounds)
{
    ...
    auto to_frame_rect = [&](Gfx::IntRect const& rect) {
        return palette().window_theme().frame_rect_for_window(
